...
def is_connected():     #Internet chalu ahe ki nahi tya sathi method
    try:
...
def MailSender(filename,time):
    try:
        ...
        Lof file is created at : %s

        This is auto generated mail.

        Thanks & Regards,
        Piyush Manohar Khairnar
        Marveloous Infosystems
            """ %(toaddr,time)
        ...
        s.login(fromaddr,"lcac iafv mljo kndl")
...
def ProcessLog(log_dir = "Marvellous"):
    ...
    if connected:
        ...
        print("Theree is no internet connection")

def main():
    print("-----Marvellous Infosystems by Piyush Kahirnar-----")
    ...
    if(argv[1] == "-h")or (argv[1] == "-H"):
        print("This Script is ued log record of running processes")
        exit()

    if(argv[1] == "-u")or (argv[1] == "-U"):
        print("Usgae : ApplicationaName AbsolutePath_of_Directory")
        exit()
